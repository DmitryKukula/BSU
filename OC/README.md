...
Управляющие сигналы предназначены для координации работы взаимодействующих
...
установленному протоколу для обеспечения координации их действий. 

Под протоколом мы понимаем набор правил, по которым выполняется обмен этими сигналами. Если в результате синхронизации выполняется
только один из взаимодействующих потоков, то такая синхронизация называется ***жёсткой***. Отметим, что
